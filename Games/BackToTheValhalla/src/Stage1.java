...
public class Stage1 extends Scenario {
    private int waveCount; // Inicializa o número de ondas
    private double waveLength; // Inicializa o comprimento da onda

    public Stage1(Color backgroundColor, Color pathColor, int waveCount, double waveLength) {
